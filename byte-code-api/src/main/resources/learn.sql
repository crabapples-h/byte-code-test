...
INSERT INTO `sys_menu` (`id`, `pid`, `icon`, `menus_type`, `name`, `permission`, `sort`, `file_path`, `path`, `link`, `show_flag`, `create_by`, `create_time`, `update_time`, `del_flag`) VALUES ('55e53dcbcf2de05d8c51f5a5982532c3', '4e5aae5a-1a1e-4b64-89a8-3dae010ec2e5', NULL, 2, '11', '11', -1, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1);
